...
<head>
    ...
    <title>@yield('title', 'Participant Dashboard - ' . config('app.name'))</title>
    ...
    <style>
        ...
        .participant-navbar .navbar-brand {
            font-weight: 700;
            letter-spacing: 0.5px;
            text-shadow: 0 2px 4px rgba(0,0,0,0.2);
        }
        
        .participant-navbar .nav-link {
            font-weight: 500;
            margin: 0 5px;
            padding: 10px 15px;
            border-radius: 30px;
        ...
        .participant-navbar .nav-link:hover {
            background: rgba(255, 255, 255, 0.15);
            transform: translateY(-2px);
        }
        
        .participant-navbar .nav-link.active {
...
<body>
    <!-- Participant Navbar -->
    <nav class="navbar navbar-expand-lg participant-navbar navbar-dark py-3">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold fs-4" href="{{ route('peserta.dashboard') }}">
                <i class="fas fa-user-graduate me-2"></i>{{ config('app.name') }} Participant
            </a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#participantNavbar" aria-controls="participantNavbar" aria-expanded="false" aria-label="Toggle navigation">
