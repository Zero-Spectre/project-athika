...
<head>
    ...
    <style>
        ...
        .instructor-navbar .navbar-brand {
            font-weight: 700;
            letter-spacing: 0.5px;
            text-shadow: 0 2px 4px rgba(0,0,0,0.2);
        }
        
        .instructor-navbar .nav-link {
            font-weight: 500;
            margin: 0 5px;
            padding: 10px 15px;
            border-radius: 30px;
        ...
        .instructor-navbar .nav-link:hover {
            background: rgba(255, 255, 255, 0.15);
            transform: translateY(-2px);
        }
        
        .instructor-navbar .nav-link.active {
...
<body>
    <!-- Instructor Navbar -->
    <nav class="navbar navbar-expand-lg instructor-navbar navbar-dark py-3">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold fs-4" href="{{ route('instruktur.dashboard') }}">
                <i class="fas fa-chalkboard-teacher me-2"></i>{{ config('app.name') }} Instructor
            </a>
