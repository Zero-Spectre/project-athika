...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Sidebar AI button functionality
            ...
            if (askAiBtn) {
                askAiBtn.addEventListener('click', function() {
                    ...
                    // Clear chat when opening from sidebar
                    clearChat();
                });
            }
                ...
                askAiButton.addEventListener('click', function() {
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            ...
                            // If it's a generic error, provide more user-friendly message
                            if (errorMessage === 'Failed to get response from Gemini AI') {
