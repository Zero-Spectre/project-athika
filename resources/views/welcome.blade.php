...
<body class="antialiased">
    <div class="container-fluid">
        ...
        <div class="container my-5">
            <h2 class="text-center mb-4">Bootstrap Components Showcase</h2>
        ...
        <!-- Buttons Section -->
        <div class="container my-5">
            <h2 class="text-center mb-4">Bootstrap Buttons</h2>
        ...
        <!-- Alerts Section -->
        <div class="container my-5">
            <h2 class="text-center mb-4">Bootstrap Alerts</h2>
        ...
        <footer class="bg-dark text-white text-center py-4 mt-5">
            <div class="container">
                <p>&copy; {{ date('Y') }} Laravel with Bootstrap. All rights reserved.</p>
            </div>
        </footer>
    </div>
</body>
